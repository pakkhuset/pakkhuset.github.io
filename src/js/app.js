  ...
  var b = i.$Jssor$ = new function () {
    ...
    function l(b, d) {
      ...
      if (pb(b) == '[object Array]') {
        ...
        for (a in b) if (c = d(b[a], a, b)) return c;
      }
    }
    ...
    j.Zc = function (c, d) {
      var a = c || {};
      if (c) if (b.qe(c)) a = { X: a }; else if (b.qe(c.$Clip)) a.$Clip = { X: c.$Clip };
      a.X = a.X || d;
  ...
  var n = {
    ...
    s = i.$JssorSlideshowFormations$ = new function () {
      ...
      h.$FormationRandom = function (d) {
        for (var e = [], a, b = 0; b < d.$Rows; b++) for (a = 0; a < d.$Cols; a++) g(e, c.Q(1e5 * c.Md()) % 13, [b, a]);
        return e;
      };
      h.$FormationCircle = function (d) {
        for (var e = d.$Cols || 1, f = d.$Rows || 1, h = [], a, i = e / 2 - .5, j = f / 2 - .5, b = 0; b < e; b++) for (a = 0; a < f; a++) g(h, c.$Round(c.fc(c.v(b - i, 2) + c.v(a - j, 2))), [a, b]);
        return h;
      };
      h.$FormationCross = function (d) {
        for (var e = d.$Cols || 1, f = d.$Rows || 1, h = [], a, i = e / 2 - .5, j = f / 2 - .5, b = 0; b < e; b++) for (a = 0; a < f; a++) g(h, c.$Round(c.j(c.H(b - i), c.H(a - j))), [a, b]);
        return h;
      };
      h.$FormationRectangleCross = function (f) {
        for (var h = f.$Cols || 1, i = f.$Rows || 1, j = [], a, d = h / 2 - .5, e = i / 2 - .5, k = c.m(d, e) + 1, b = 0; b < h; b++) for (a = 0; a < i; a++) g(j, c.$Round(k - c.m(d - c.H(b - d), e - c.H(a - e))) - 1, [a, b]);
        return j;
      };
    };
